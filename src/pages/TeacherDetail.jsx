    ...
    <div className="content-inner">
      ...
      <div className="page-header">
        ...
        <div className="page-header-actions">
          ...
          <button className="btn-primary" onClick={() => navigate("/teachers/add")}>Add Teachers</button>
        </div>
      </div>
      ...
      <div className="detail-card">
        ...
        <div className="detail-left">
          ...
          <div className="detail-actions">
            ...
            <button className="detail-icon-btn" title="Email">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#374151" strokeWidth="1.8">
        ...
        <div className="detail-right">
          ...
          <div className="detail-meta">
            <div>
              <p className="detail-meta-label">Age</p>
              <p className="detail-meta-value">{teacher.age}</p>
            </div>
            <div>
              <p className="detail-meta-label">Gender</p>
              <p className="detail-meta-value">{teacher.gender}</p>
            </div>
          </div>

          <div className="detail-same-class">
            <p className="detail-section-title">Teachers from the same class</p>
            <div className="same-class-avatars">
              ...
              {sameClass.length > 4 && (
                <span className="same-class-more">+{sameClass.length - 4} more</span>
              )}
            </div>
          </div>
        </div>
