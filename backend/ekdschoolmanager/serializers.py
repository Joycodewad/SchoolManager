...
class CustomUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "secondary_subject", "tertiary_subject", "is_active", "is_archived",
    ...
    def validate(self, attrs):
        ...
        subjects = [attrs.get(name, getattr(self.instance, name, "")) for name in (
            "primary_subject", "secondary_subject", "tertiary_subject"
        )]
        selected = [subject.strip().lower() for subject in subjects if subject]
...
class StudentEnrollmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id", "enrollment_number", "student", "student_name",
            "student_username", "gender_label", "date_of_birth_display", "status", "enrolled_at",
            "level", "level_name", "level_stage", "last_name", "first_names", "gender", "date_of_birth", "address",
        ]
