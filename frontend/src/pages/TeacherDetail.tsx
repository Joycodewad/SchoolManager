...
export default function TeacherDetail() {
  ...
  if (!teacher) return (
    <div className="content-inner">
      ...
      <button className="btn-primary" onClick={() => navigate(`/schools/${schoolId}/teachers`)}>Retour</button>
    </div>
  );
  ...
  return (
    <div className="content-inner">
      ...
      <div className="page-header">
        <button className="btn-back" onClick={() => navigate(`/schools/${schoolId}/teachers`)}>
        ...
        <div className="page-header-actions">
          ...
          <button className="btn-primary" onClick={() => navigate(`/schools/${schoolId}/teachers/add`)}>Ajouter des enseignants</button>
        </div>
      </div>
